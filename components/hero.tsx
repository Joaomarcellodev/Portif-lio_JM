...
export default function Hero() {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: "https://www.linkedin.com/in/joaomarcellodev/", label: "LinkedIn" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold text-balance leading-tight">
                Olá, eu sou o <span className="text-primary">João Marcello</span>
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground font-medium">Desenvolvedor FullStack</p>
              <p className="text-lg text-muted-foreground max-w-2xl text-pretty leading-relaxed">
                Apaixonado por tecnologia e sempre em busca de soluções criativas para problemas do dia a dia. Foco no
                progresso, que o resto é sucesso!
              </p>
            </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative cursor-pointer group" onClick={handleImageClick}>
              <div className="w-80 h-80 rounded-full overflow-hidden border-4 border-primary/20 group-hover:border-primary/40 transition-all duration-300">
                <img
                  src={
                    imageToggled
                  ...
                  style={{
                    transform: imageToggled ? "rotateY(180deg)" : "rotateY(0deg)",
                    opacity: 1,
                  }}
                />
              </div>
